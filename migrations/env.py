...
from bot.models.table_models.created_conferences import CreatedConferences
from bot.models.table_models.user_chat import UserChat
...
config.set_main_option("public", "my_schema")
